...
pip3 install gdown
gdown https://drive.google.com/u/0/uc?id=1nEcobGN7_8yyYwdqs1c6XD1UTXqEyhQC&export=download && tar xzf pre-models.tgz

gdown https://drive.google.com/u/0/uc?id=1T_hx9Pqopk-rlmiSrBWdXjl825wjBQVF&export=download && tar xzf data.tar.gz
